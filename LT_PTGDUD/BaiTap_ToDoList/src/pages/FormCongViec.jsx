...
function FormCongViec() {
    ...
    const todoList = listCV.filter(cv => !cv.TrThai);
    const doneList = listCV.filter(cv => cv.TrThai);
    ...
    <div className="list_container">
        <div className="list_done">
            <CongViec listCV={doneList} onEdit={handleEdit} title = "Danh sách CV hoàn thành" />
        </div>
        <div className="list_Todo">
            <CongViec listCV={todoList} onEdit={handleEdit} title = "Danh sách CV chưa hoàn thành" />
        </div>
    </div>
</div>
